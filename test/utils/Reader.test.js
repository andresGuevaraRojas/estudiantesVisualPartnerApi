...
describe('Test for Reader class', () => {
    test('Regresa el mismo numero de elementos que el archivo', () => {
        const data = Reader.readJsonFile('test/data/visualpartners.json')

        expect(data.length).toBe(10)
    })

    test('Regresa los mismos elementos que el archivo', () => {
        const data = Reader.readJsonFile('test/data/visualpartners.json')
